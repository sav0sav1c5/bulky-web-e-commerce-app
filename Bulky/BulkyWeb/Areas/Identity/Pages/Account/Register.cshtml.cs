...
namespace BulkyWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        // Add UnitOfWork - need to fill dropdown and pass it Razor pages
        ...
        public class InputModel
        {
            ...
            // Add CompanyList inside InputModel  ->  Populate list in Task OnGetAsync
            [ValidateNever]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Adding id of choosed company in CompanyId 
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        // If he do not have a role we will give him role 'CLIENT'
        ...
        // Changed default method to create instance of 'ApplicationUser' rather than 'IdentityUser'
